...
const ExecutivePanelPage = () => {
  return (
    <>
      <PageBanner 
        title="BUZZWEBINAR - Panel Members" 
      ...
      <section className="panel-intro" style={{ textAlign: 'center', padding: '2rem 1rem' }}>
        ...
        <p style={{ color: '#4b5563', fontSize: '1.1rem', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
          Leading global scientists, researchers, and innovators shaping the future of Business Economics & Foreign Trade, and advanced manufacturing at Annual Global Summit on Business Economics & Foreign Trade
        </p>
      </section>
