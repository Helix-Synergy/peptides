      ...
      <div className="container">
        <div className="about-grid">
          <div className="about-content">
            ...
            <p className="about-text">
              The <strong>Annual Global Summit on Business, Economics & Foreign Trade</strong> brings together people who are curious about these changes and want to be part of the conversation—business leaders, entrepreneurs, economists, academicians, and professionals from around the world.
            </p>
            <p className="about-text">
