    ...
    <section className="about-content-section" style={{ padding: '4rem 0' }}>
      <div className="container">
        ...
        <div className="about-header text-center" style={{ marginBottom: '3rem' }}>
          <h2 className="section-title">Annual Global Summit on Business, Economics & Foreign Trade</h2>
        ...
        <div className="about-block" style={{ marginBottom: '3rem' }}>
          ...
          <p style={{ fontSize: '1.1rem', lineHeight: '1.7', marginTop: '1rem' }}>
            The Annual Global Summit on Business, Economics & Foreign Trade brings together people who are curious about these changes and want to be part of the conversation—business leaders, entrepreneurs, economists, academicians, researchers, policymakers, professionals, and students from around the world.
          </p>
          <p style={{ fontSize: '1.1rem', lineHeight: '1.7', marginTop: '1rem' }}>
        ...
        <div className="about-block" style={{ marginBottom: '3rem', padding: '2rem', backgroundColor: '#f8fafc', borderRadius: '12px', borderLeft: '5px solid var(--primary)' }}>
          ...
          <h4 style={{ fontSize: '1.25rem', marginBottom: '1rem', fontWeight: 'bold', color: 'var(--secondary)' }}>“Navigating Global Economic Transformation, International Trade & the Future of Business”</h4>
          <p style={{ fontSize: '1.1rem', lineHeight: '1.7' }}>
            From the rise of digital businesses and AI to changing international trade and emerging markets, the summit looks at the developments that are shaping how we work, trade, invest, and grow.
          </p>
        </div>
        ...
        <div className="about-block" style={{ marginBottom: '3rem' }}>
          ...
          <ul style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '10px', listStyleType: 'disc', paddingLeft: '20px', fontSize: '1.1rem', lineHeight: '1.6' }}>
            <li>Global business and emerging economic trends</li>
            <li>International trade and foreign markets</li>
            <li>Entrepreneurship, startups and innovation</li>
            <li>Finance, investment and global markets</li>
            <li>Artificial Intelligence and digital transformation</li>
            <li>Sustainable and responsible business</li>
            <li>Global supply chains and logistics</li>
            <li>International marketing and changing consumer behaviour</li>
            <li>Economic policies and global development</li>
            <li>E-commerce and digital trade</li>
            <li>MSMEs and opportunities in international markets</li>
        ...
        <div className="about-block" style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
            ...
            <div style={{ backgroundColor: 'white', padding: '1.5rem', borderRadius: '8px', boxShadow: '0 4px 6px rgba(0,0,0,0.05)' }}>
              ...
              <p style={{ fontSize: '1rem', lineHeight: '1.6' }}>Present your research, experiences, business ideas, case studies, and perspectives to an audience that values fresh thinking.</p>
            </div>
            <div style={{ backgroundColor: 'white', padding: '1.5rem', borderRadius: '8px', boxShadow: '0 4px 6px rgba(0,0,0,0.05)' }}>
            ...
            <div style={{ backgroundColor: 'white', padding: '1.5rem', borderRadius: '8px', boxShadow: '0 4px 6px rgba(0,0,0,0.05)' }}>
              ...
              <p style={{ fontSize: '1rem', lineHeight: '1.6' }}>Explore possibilities for research partnerships, industry collaborations, business connections, entrepreneurship, investment, and career growth.</p>
            </div>
            <div style={{ backgroundColor: 'white', padding: '1.5rem', borderRadius: '8px', boxShadow: '0 4px 6px rgba(0,0,0,0.05)' }}>
              <h4 style={{ fontWeight: 'bold', color: 'var(--secondary)', marginBottom: '0.5rem', fontSize: '1.2rem' }}>Look beyond today</h4>
              <p style={{ fontSize: '1rem', lineHeight: '1.6' }}>Understand the trends that could influence businesses, economies, careers, and international markets in the years ahead.</p>
            </div>
          </div>
        </div>
        ...
        <div className="about-block" style={{ marginBottom: '3rem', padding: '2.5rem', backgroundColor: '#f8fafc', borderRadius: '12px' }}>
          ...
          <p style={{ fontSize: '1.1rem', marginBottom: '1rem' }}>The summit welcomes anyone with an interest in business, economics, and global trade, including:</p>
          <p style={{ fontWeight: 'bold', color: 'var(--secondary)', marginBottom: '1.5rem', fontSize: '1.1rem', lineHeight: '1.8' }}>
            Business Leaders | Entrepreneurs | Economists | Academicians | Researchers | Industry Professionals | Investors | Policymakers | Students | Young Professionals | Consultants
          </p>
          <p style={{ fontSize: '1.1rem' }}>
            Whether you are an experienced professional or someone taking your first steps into the world of business and economics, there is something here for you.
          </p>
        </div>
        ...
        <div className="about-block" style={{ textAlign: 'center', marginTop: '4rem', padding: '3.5rem 2rem', backgroundColor: 'var(--secondary)', color: 'white', borderRadius: '16px', boxShadow: '0 10px 25px rgba(0,0,0,0.1)' }}>
          ...
          <p style={{ maxWidth: '800px', margin: '0 auto', fontSize: '1.15rem', marginBottom: '1.5rem', lineHeight: '1.7' }}>
            The future of business and economics is not being shaped by one person, one industry, or one country. It is being shaped by ideas, conversations, collaborations, and the decisions we make today.
          </p>
          <p style={{ maxWidth: '800px', margin: '0 auto', fontSize: '1.15rem', marginBottom: '2rem', lineHeight: '1.7' }}>
            The Annual Global Summit on Business, Economics & Foreign Trade is an invitation to be part of that journey.
          </p>
