...
const Footer = () => {
  ...
  useEffect(() => {
    const fetchVisitorCount = async () => {
      try {
        const hasVisited = sessionStorage.getItem('visitedBuzz');
        const queryParams = hasVisited ? '' : '?increment=true';
        
        if (!hasVisited) {
          sessionStorage.setItem('visitedBuzz', 'true');
        }
        
        const API_URL = import.meta.env.VITE_API_BASE_URL;
        const response = await fetch(`${API_URL}/buzz-visitors${queryParams}`);
      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-col footer-col-logo">
            ...
            <p className="footer-tagline">
              "Securing the Future with Business Economics & Foreign Trade"
            </p>
        ...
        <div className="footer-bottom-bar">
          <div className="copyright-text">
            &copy; {new Date().getFullYear()} Business Economics. All Rights Reserved.
          </div>
