    ...
    <>
      ...
      <div className="orators-intro-section" style={{ textAlign: 'center', padding: '4rem 1rem 1rem' }}>
        ...
        <p style={{ color: '#4b5563', fontSize: '1.1rem', maxWidth: '800px', margin: '0 auto' }}>
          International researchers and foreign trades experts driving breakthrough innovations at Global Conclave on Artificial Intelligence & Machine Learning
        </p>
      </div>
