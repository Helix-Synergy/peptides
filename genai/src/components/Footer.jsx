  ...
  useEffect(() => {
    const fetchVisitorCount = async () => {
      try {
        ...
        const response = await fetch(`${API_URL}/genai-visitors${queryParams}`);
      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-col footer-col-logo">
            ...
            <p className="footer-tagline">
              "Securing the Future with Business Artificial Intelligence & Foreign Trade"
            </p>
        ...
        <div className="footer-bottom-bar">
          <div className="copyright-text">
            &copy; {new Date().getFullYear()} Business Artificial Intelligence. All Rights Reserved.
          </div>
