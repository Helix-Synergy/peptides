...
const homeTracksPath = path.join(__dirname, 'src', 'components', 'HomeTracks.jsx');
...
fs.writeFileSync(homeTracksPath, newContent);
console.log('HomeTracks.jsx updated with AI tracks.');
