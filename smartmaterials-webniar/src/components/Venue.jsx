  ...
  return (
    <section className="venue-section">
      <div className="container">
        <h2 className="section-title">SMARTMATERIALS-Venue</h2>
        ...
        <div className="view-all-container" style={{ textAlign: 'center', marginTop: '3rem' }}>
          <button className="btn btn-primary" style={{ backgroundColor: '#3b82f6', color: 'white', padding: '0.6rem 3rem', borderRadius: '25px', border: 'none', fontWeight: '500', cursor: 'pointer' }}>
            View All
          </button>
        </div>
      </div>
