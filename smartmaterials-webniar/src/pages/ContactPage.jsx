...
const ContactPage = () => {
  ...
  return (
    <div className="contact-page-wrapper">
      <PageBanner 
        title="SMARTMATERIALS - Contact Us" 
          ...
          <div className="contact-grid">
            ...
            <div className="contact-info-block">
              ...
              <p className="contact-subheading">
                Have questions about the SMART MATERIALS - 2026 congress? Our team is ready to help you with registration, abstract submission, or partnership inquiries.
              </p>
