    ...
    <section id="register" className="section registration-section">
      ...
      <div className="container reg-container">
        ...
        <div className="text-center mb-5">
            ...
            <p className="reg-subtitle">Secure your spot for the International conference on Pharmaceutical Sciences. Fill out the details below to complete your registration and unlock exclusive benefits.</p>
        </div>
